...
<html>
	...
	<?php
		...
		if( !empty($_POST['save']) )
		{
			...
			$query=mysqli_query($koneksi,"UPDATE diskon SET diskon='$diskon', id_level='$id_level' where id_diskon='$id'");
        ...
        $query_mysqli = mysqli_query($koneksi,"SELECT * FROM diskon d LEFT JOIN level l on d.id_level = l.id_level  WHERE  d.id_diskon='$id'")or die(mysqli_error());
        $nomor = 1;
		...
		<div class="container">		
			...
			<form class="form-horizontal"  method="POST">
				<div class="form-group">
					...
					<div class="col-sm-5">
                        <input type="hidden" class="form-control" name="id" value="<?php echo $data['id_diskon'];?>">
