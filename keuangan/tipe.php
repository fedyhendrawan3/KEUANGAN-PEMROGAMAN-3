...
?>
	<html>
		...
		<body>
			<h2>MODULE TIPE</h2>
			<br/>
			<td>Search <input type="text" name="searchtipe" id="searchtipe"></td>
			<br/>
			<br/>
...
?>
				...
				<tr>
					...
					<td>
						<a href="edit_kategori.php?id=<?php echo $fedy["id_tipe"] ?>">EDIT</a>
						<a href="hapus_kategori.php?id=<?php echo $fedy["id_tipe"] ?>">HAPUS</a>
					</td>
				</tr>
				</tbody>
<?php
